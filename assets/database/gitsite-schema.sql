...
--
-- Host: localhost    Database: gitsite
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=31 DEFAULT CHARSET=utf8 COMMENT='Stores block settings, such as region and visibility sett...';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `watchdog` (
  ...
  KEY `type` (`type`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=4964 DEFAULT CHARSET=utf8 COMMENT='Table that contains logs of all system events.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2018-09-25 11:45:08
